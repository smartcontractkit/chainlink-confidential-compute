module github.com/smartcontractkit/confidential-compute/enclave/config-tracker
...
require (
	...
	github.com/smartcontractkit/confidential-compute v0.0.0-20250708191655-e9033561ddd9
