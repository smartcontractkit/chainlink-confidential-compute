# Confidential HTTP Canary workflow

This workflow uses a predeployed [PoR contract](https://sepolia.etherscan.io/address/0xd8c1F54593f8D5CBA92011335ef6AcC9E4F1c4a1#events) to push block numbers fetched from a permissioned Infura RPC node. It is mainly a cutout of auto-generated CLI materials, with our confidential http capability swapped in for the regular http capability.

The owner of this workflow should be `0xbb62d78235e4b770618d06bc2fa71daca6b7dc0a` (DM for EOA).
...
To deploy the workflow, use the CRE CLI binary:
`cre workflow deploy blocknumber-tracker` or `/path/to/cre_cli_binary workflow deploy blocknumber-tracker`

Everything below this point is boilerplate auto-generated by the CRE CLI.
