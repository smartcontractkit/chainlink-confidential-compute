...
This script is the implementation behind the `diagrams` composite action and
runs against the calling repository's checkout. Repo-specific configuration
belongs in that repository's manifest, not here.
"""
